...
<div class="banner-image w-100 vh-100 d-flex justify-content-center align-items-center">
    ...
    <form action="includes/signup.inc.php" method="post">
        <h2 class="text-center">Reserve Spot</h2>		
		<div class="or-seperator text-primary"> <strong>PRO</strong> </div>
        ...
        <div class="form-group">
            <button  type="submit" name="submit"  class="btn btn-success btn-block login-btn">Submit</button>
        </div>
